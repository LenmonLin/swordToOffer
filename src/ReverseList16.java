 ...
 * 解题思路：
 * 1、要用到三个指针，分别指向遍历的结点pNode,遍历的结点的前一个结点preNode,遍历结点的后一个结点pNextNode;
...
public class ReverseList16 {
    public ListNodeCommom ReverseList(ListNodeCommom head) {
        ...
        //为什么不用判断输入的head即pNode为不为空，因为返回的是pReversedHead，用的是while，如果head为空，
        //返回的pReversedHead即为空
        while (pNode != null){
            pNext = pNode.next;
            if (pNext ==null){
    ...
    public static void main(String[] args) {
        ...
        ReverseList16 test = new ReverseList16();
